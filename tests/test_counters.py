...
@pytest.mark.asyncio
async def test_play_sacrifice_when_one_rivals_defeated(gs, fast_zombie, zombie, big_zombie):
    gs.players = [PlayerShelter('ZERO'), PlayerShelter('FIRST'), PlayerShelter('SECOND')]
...
@pytest.mark.asyncio
async def test_play_drone(gs, fast_zombie, zombie, big_zombie):
    gs.players = [PlayerShelter('ZERO'), PlayerShelter('FIRST'), PlayerShelter('SECOND')]
...
@pytest.mark.asyncio
async def test_play_drone_chose_lesser(gs, fast_zombie, zombie, big_zombie):
    gs.players = [PlayerShelter('ZERO'), PlayerShelter('FIRST'), PlayerShelter('SECOND')]
    gs.active_player = gs.players[0]
    shelter = gs.active_player
    shelter.print = dumper_factory()
...
@pytest.mark.asyncio
async def test_play_drone_only_lesser_one_rival(gs, big_zombie):
    gs.players = [PlayerShelter('ZERO'), PlayerShelter('FIRST'), PlayerShelter('SECOND')]
    gs.active_player = gs.players[0]
...
@pytest.mark.asyncio
async def test_play_lure_out(gs, fast_zombie, zombie, big_zombie):
    gs.players = [PlayerShelter('ZERO'), PlayerShelter('FIRST'), PlayerShelter('SECOND')]
    gs.active_player = gs.players[0]
    shelter = gs.active_player
    shelter.print = dumper_factory()
...
@pytest.mark.asyncio
async def test_play_lure_out_lesser_zombie(gs, fast_zombie, zombie, big_zombie):
    gs.players = [PlayerShelter('ZERO'), PlayerShelter('FIRST'), PlayerShelter('SECOND')]
    gs.active_player = gs.players[0]
    shelter = gs.active_player
    shelter.print = dumper_factory()
...
@pytest.mark.asyncio
async def test_play_lure_only_city(gs, zombie):
    gs.players = [PlayerShelter('ZERO'), PlayerShelter('FIRST'), PlayerShelter('SECOND')]
    gs.active_player = gs.players[0]
    shelter = gs.active_player
    shelter.print = dumper_factory()
